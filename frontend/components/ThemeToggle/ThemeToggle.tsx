...
export function ThemeToggle() {
  ...
  return (
    <button className={css.themeToggle} title="Toggle theme" onClick={switchTheme}>
      {theme === "dark" ? (
        <svg className={css.sun} width="32" height="32" viewBox="0 0 32 32">
        ...
        <svg className={css.moon} width="32" height="32" viewBox="0 0 32 32">
